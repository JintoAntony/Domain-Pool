					...
					<div class="right">
						<nav>
							<ul>
								...
								<li  class="current"><a href="sell_domains.php">Sell Domains</a></li>
...
<h2 class="extra">Available Domains</h2>
				...
				<table width="95%" cellpadding="3" cellspacing="2" style="text-align:center; font-family:Lucida Sans Unicode, Lucida Grande, sans-serif; font-size:14px;" border="1">
                        <tr>
