					...
					<div class="right">
						<nav>
							<ul>
								...
								<li class="current"><a href="buy_domains.php">Buy Domains</a></li>
...
<table width="95%" cellpadding="5" cellspacing="2" style="text-align:center; font-family:Lucida Sans Unicode, Lucida Grande, sans-serif; font-size:14px;" border="1">
                        <tr>
...
//echo $user_id;
//echo $domain;
$query2 = "select * from request_domain WHERE request_user_id='$user_id' and request_domain_id='$domain' ";
...
echo "while2";
echo $row['domain_id'];
echo $row2['request_domain_id'];  */
		
					if(($row['domain_id'] ==$row2['request_domain_id']) )
					{
					//echo "duplicate here";				
					}	
					else 
					{
						...
						echo '<td>
						<a href="process_request_domain.php?domain_id='.$row['domain_id'].'&&user_id='.$user_id.'" style="text-decoration:none; color:blue; border:none;"><u>Request</u></a>
						</td></tr>';		
					}
