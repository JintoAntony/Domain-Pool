  ...
  <!--	 <span style="position: relative;color: #771F8D;font-weight: 700;font-style: normal;font-size: 30px;
	...
	<div id="option">
		<!--	<ul>
			...
			<div id="menu">
			<ul>
				<li><a href="buyer_management.php">Back</a></li>
			<ul>
            </div> 
            <br/> <br/>  <br/>  <br/>  <br/>
            <br/>			
			...
			<center><h2 style="color:green;font-size:30px;">Search Buyer</h2></center> <br/>
				
			    <form action="process_search_buyer.php" method="post">
				<center>
				<input style="color:green; height: 30px; width: 400px;"  type="text" name="search" id="search" placeholder="Enter Buyer Email Id">
